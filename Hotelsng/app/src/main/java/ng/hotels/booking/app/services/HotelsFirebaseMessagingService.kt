package ng.hotels.booking.app.services
...
class HotelsFirebaseMessagingService: FirebaseMessagingService() {

    private var TAG = "HotelsFirebaseMessagingService"
    ...
    private fun createNotification(notificationTitle: String?, notificationContent: String?, imageUrl: String?, remoteMessage: RemoteMessage?) {
        ...
        // Let's create a notification builder object
        val builder: NotificationCompat.Builder = NotificationCompat.Builder(this, resources.getString(
