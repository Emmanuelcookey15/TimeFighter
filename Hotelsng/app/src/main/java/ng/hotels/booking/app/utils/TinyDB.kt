...
//        }
    ...
    companion object {
        ...
        const val HOTELS_NEAR_YOU_DATA_WAS_STORED = "hotels_near_you_data"
        const val RECOMMENDED_HOTELS_DATA_WAS_STORED = "recommended_hotels_data_stored"
        const val USER_FIRST_TIME = "pref_user_first_time"
        const val USER_FIRST_TIME_BOOKING = "pref_user_first_time_booking"
        const val API_TOKEN = "api_token"
        const val EXPIRY_TIME = "time_stored"
        const val LOCATION = "location"
        const val HOTELS_DATA = "hotel_data"
        const val PAGENUMBER = "page_number"
        const val ROOMPRICE = "room_price"
        const val ROOMINFO = "room_infro"
        const val TOTALROOMINFO = "total_room_info"
        const val SORT_BY = "sort_by"
        const val SORTED_VALUE = "sorted_value"
        const val BookingResponse = "booking_response"
        const val BookingSuccess = "booking_success"
        const val BookingsHistory = "booking_history"
        const val COUNTRYSELECTED = "countries"
        const val FAVOURITES = "favourites"
        const val DATAPLANS = "data_plans"
        const val ARRAYOFHOTELSIMAGES = "image_url_array"
        const val UpdateTheHotelData = "update_the_hotel_data"
        const val SPINNERVALUE = "spinner_value"
