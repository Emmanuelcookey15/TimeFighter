...
//        }
    ...
    companion object {
        ...
        const val OutletName = "outlet_name"
        const val OutletID = "outlet_id"
        const val OutletUID = "outlet_uid"
        const val Business_ID = "business_category_id"
        const val Transaction = "transaction"
        const val TotalTransactionPrice = "total_transaction_price"
        const val OverallTransactionPrice = "overall_transaction_price"
