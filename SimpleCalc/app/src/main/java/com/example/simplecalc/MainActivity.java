...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResultTextView = findViewById(R.id.calc_tototal);
        mOperandOneEditText = findViewById(R.id.calc_first_num);
        mOperandTwoEditText = findViewById(R.id.calc_second_num);
    }
